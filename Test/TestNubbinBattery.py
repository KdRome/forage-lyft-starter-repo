...
class TestNubbinBattery(unittest.TestCase):
    ...
    def test_needs_service(self):
        ...
        #setting last service date to more than 4 years back
    ...
    def test_doesnt_need_service(self):   
        #setting current date to todays date
        current_date = datetime.fromisoformat("2023-01-21")
        #setting last service date to less than 4 years back
        last_service_date = datetime.fromisoformat("2021-01-21")
        battery = NubbinBattery(current_date, last_service_date)
